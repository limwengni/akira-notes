...
**Focus:** strings are just character arrays — most problems are about comparing or counting characters.
...
**Focus:** two pointers = one at the start, one at the end (or both moving forward). Works great on sorted arrays or palindrome-type problems.
...
| Climbing Stairs | Easy | [leetcode.com/problems/climbing-stairs](https://leetcode.com/problems/climbing-stairs) |
| + re-attempt 1–2 problems you couldn't solve earlier | — | — |

**Focus:** Climbing Stairs is your first taste of dynamic programming — just notice the pattern, don't stress it yet.

---

## After the 5 days
1–2 hours/day is solid. Don't rush into medium problems. Once you can solve most of the above without hints, then move on to:
- Sliding Window
- Binary Search
- Linked Lists
